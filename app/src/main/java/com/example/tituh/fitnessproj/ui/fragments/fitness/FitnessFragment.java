...
public class FitnessFragment extends BaseFragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mListFitStarModel.add(new FitnessStartModel("PREPARE", "LEARN MORE", FitnessStartModel.ONE_TYPE));
        mListFitStarModel.add(new FitnessStartModel("12 WEEK WORKOUT GUIDE", "LEARN MORE", FitnessStartModel.ONE_TYPE));
        mListFitStarModel.add(new FitnessStartModel("GLOSSARY", FitnessStartModel.TWO_TYPE));
